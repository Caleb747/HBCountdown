...
const text = ['w', 'e ', 'w', 'i', 'l', 'l', ' ', 'b', 'e', ' ', 'e', 'n', 'j', 'o', 'y', 'i', 'n', 'g', ' ', 'f', 'r', 'e', 's', 'h', ' ', 'a', 'i', 'r', '😊', '😉'];
/* end Hidden */
...
setTimeout(() => {
  alert("Tap on the jelly fishes to reveal the massage")
}, 5_000);

setInterval(() => {
  let endGame = confirm("Did you get all the message? \nOK for Yes --- Cancel for NO")

  if(endGame){
    alert("Wonderful! We have reached the end \nWish you a fantastic day \nGoodbye!")
